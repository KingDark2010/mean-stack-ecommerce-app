...
export class ProductsService {
    ...
    createProduct(product: FormData): Observable<ProductObject> {
        return this._http.post<ProductObject>(
            `${this.URL}product/add`,
            product
        );
    }
    deleteProduct(productID: string | undefined): Observable<ProductObject> {
        return this._http.delete<ProductObject>(
            `${this.URL}product/delete/${productID}`
        );
    }
    updateProduct(
        ...
        return this._http.put<ProductObject>(
    ...
    getOrderProduct(
        productID: string | undefined
    ): Observable<OrderProductObject> {
        return this._http.get<OrderProductObject>(
