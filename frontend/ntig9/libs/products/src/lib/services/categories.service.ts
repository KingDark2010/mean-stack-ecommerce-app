...
import { CategoriesObject, CategoryObject } from '@ntig9/main-lib';
...
export class CategoriesService {
   ...
   */
    ...
    createCategory(category: CategoriesObject): Observable<CategoryObject> {
        return this._http.post<CategoryObject>(
            `${this.URL}category/add`,
            category
        );
    }
    deleteCategory(categoryID: string | undefined): Observable<CategoryObject> {
        return this._http.delete<CategoryObject>(
            `${this.URL}category/delete/${categoryID}`
        );
    }
    updateCategory(
        ...
        return this._http.put<CategoryObject>(
            `${this.URL}category/update/${categoryID}`,
            update
        );
    }
    getCategory(categoryID: string | undefined): Observable<CategoryObject> {
        return this._http.get<CategoryObject>(
